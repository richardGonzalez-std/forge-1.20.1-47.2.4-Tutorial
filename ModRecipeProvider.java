...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        oreBlasting(pWriter,SAPPHIRE_SMELTABLE,RecipeCategory.MISC,ModItems.RAW_SAPPHIRE.get(),0.5f,190,"sapphire");
        oreSmelting(pWriter,SAPPHIRE_SMELTABLE,RecipeCategory.MISC,ModItems.RAW_SAPPHIRE.get(),0.25f,100,"sapphire");
